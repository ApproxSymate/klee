...
private:
  Z3ErrorASTHandle one();
  Z3ErrorASTHandle zero();
  Z3ErrorASTHandle minusOne();
  Z3ErrorASTHandle realConst(uint64_t value);
  Z3ErrorASTHandle intConst(uint64_t value);
  Z3ErrorASTHandle zExtConst(uint64_t value);
  Z3ErrorASTHandle sExtConst(uint64_t value);
  Z3ErrorASTHandle boolExtract(Z3ErrorASTHandle expr);
  Z3ErrorASTHandle extract(Z3ErrorASTHandle expr, unsigned top,
                           unsigned bottom);
  Z3ErrorASTHandle eqExpr(Z3ErrorASTHandle a, Z3ErrorASTHandle b);

  // logical left and right shift (not arithmetic)
  Z3ErrorASTHandle leftShift(Z3ErrorASTHandle expr, unsigned shift);
  Z3ErrorASTHandle rightShift(Z3ErrorASTHandle expr, unsigned shift);
  Z3ErrorASTHandle varLeftShift(Z3ErrorASTHandle expr, Z3ErrorASTHandle shift);
  Z3ErrorASTHandle varRightShift(Z3ErrorASTHandle expr, Z3ErrorASTHandle shift);
  Z3ErrorASTHandle varArithRightShift(Z3ErrorASTHandle expr,
  ...
  Z3ErrorASTHandle ltExpr(Z3ErrorASTHandle lhs, Z3ErrorASTHandle rhs);
  Z3ErrorASTHandle leExpr(Z3ErrorASTHandle lhs, Z3ErrorASTHandle rhs);
  Z3ErrorASTHandle sLtExpr(Z3ErrorASTHandle lhs, Z3ErrorASTHandle rhs);
  Z3ErrorASTHandle sLeExpr(Z3ErrorASTHandle lhs, Z3ErrorASTHandle rhs);
